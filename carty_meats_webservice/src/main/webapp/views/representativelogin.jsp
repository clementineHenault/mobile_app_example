...
<link href="assets/includes/css/bootstrap-glyphicons.css"
	rel="stylesheet">
	...
	<div class="container" id="main">
		...
		<div class="container" align="center">
			<form class="form-signin" method="post"
				...
				<label class="sr-only">User Name</label> <input type="text"
					id="inputUsername" class="form-control" placeholder="User Name"
					name="username" required autofocus> <br></br> <label
